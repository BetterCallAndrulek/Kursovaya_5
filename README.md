# Kursovaya_5
!!! Для работы программы необходимо запустить файл main.py. Через терминал выполните команду:

$ python3 main.py

Для корректной работы введите ваш пароль и логин от Postgres в файл database.ini
